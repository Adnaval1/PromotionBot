/* SETTINGS START */
const prefix = "!"
const groupID = 3857585;
const bot_token = process.env.botToken;
const rblxCookie = process.env.rblxCookie;
const officerRoleE = "Bestower";
const welcomeMessage = "Welcome to Valania's Communication Hub. Follow the format in #perms-request to receive roles.";
const maxXP = 20;
const xpAuditLogChannelID = "597441568106086420";
const mainChatChannelID = "675426259672629270";
